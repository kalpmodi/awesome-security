...
- [Akira](https://github.com/Kalp1774/akira) - AI pentest co-pilot with phase-chained skills for Claude Code, Gemini CLI and more. Evidence-gated findings, 12 attack modules covering the full engagement lifecycle from recon to report.
